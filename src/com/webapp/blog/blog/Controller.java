...
//        Action.add(new DeleteAction(model));
        ...
        Action.add(new Registration(model));
        Action.add(new Home(model));
        Action.add(new Post(model));
        Action.add(new Logout(model));
        Action.add(new DeletePost(model));
        Action.add(new Comment(model));
        Action.add(new DeleteHomeComment(model));
        Action.add(new Visit(model));
        Action.add(new DeleteComment(model));
        Action.add(new VisitComment(model));
//        Action.add(new ToDoListAction(model));
    ...
    private String performTheAction(HttpServletRequest request) {
        ...
        User user = (User) session.getAttribute("todolist5_user");
        ...
        if (action.equals("visit.do")) {
            return Action.perform("visit.do", request);
        }
        ...
        if (action.equals("registration.do")) {
            return Action.perform("registration.do", request);
        }
